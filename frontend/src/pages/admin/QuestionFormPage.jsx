  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const questionData = {
        ...
        imagePath: formData.imagePath, // Usar el imagePath del estado
        difficulty: "medium", // O tomarlo del formulario
    ...
    try {
      ...
      if (res.data && res.data.questions) {
        ...
        if (
          ...
          throw new Error(
            "La respuesta de la IA no tiene la estructura esperada"
          );
        }
      } else {
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <p className="text-sm text-gray-500 mt-4 text-center">
                  ...
                  <Check size={14} className="inline mx-1" /> para marcar la
                  respuesta correcta
                </p>
              </div>
