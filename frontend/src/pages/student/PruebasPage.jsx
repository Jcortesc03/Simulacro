...
// 🎓 Configuración de pruebas con IDs reales de la BD
const pruebas = [
  {
...
// 🏆 Card de simulacro general institucional
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-slate-300 text-lg leading-relaxed max-w-2xl mx-auto">
            Evaluación completa que integra todas las competencias académicas en una experiencia
            similar al examen oficial. Ideal para medir tu preparación integral.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="text-center p-4 bg-slate-600/30 rounded-lg backdrop-blur-sm">
            ...
            <h4 className="text-white font-semibold text-sm">Todas las Áreas</h4>
          ...
          <div className="text-center p-4 bg-slate-600/30 rounded-lg backdrop-blur-sm">
            ...
            <h4 className="text-white font-semibold text-sm">Análisis IA</h4>
            <p className="text-slate-300 text-xs mt-1">Retroalimentación detallada</p>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 text-xs mt-3">
            Evaluación completa • Tiempo estimado: 2.5 horas
          </p>
        </div>
      </div>
    </div>
...
const ConfigurationModal = ({ show, onClose, onConfirm, prueba, questionCount, setQuestionCount }) => {
  ...
  return (
    <ConfirmationModal
      ...
      cancelText="Cancelar"
    >
      {/* Header del modal con información de la prueba */}
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              {isGeneralSimulacro ? 'Evaluación integral de competencias' : 'Práctica específica de competencia'}
            </p>
          </div>
        </div>
      </div>
